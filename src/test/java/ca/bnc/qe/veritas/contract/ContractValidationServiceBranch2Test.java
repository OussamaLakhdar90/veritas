...
class ContractValidationServiceBranch2Test {
    ...
    void setUp() throws Exception {
        ...
        // Response de-duplication is a passthrough by default (real logic in CorrectedSpecBuilderTest).
        when(correctedSpecBuilder.deduplicateResponses(any())).thenAnswer(inv -> inv.getArgument(0));

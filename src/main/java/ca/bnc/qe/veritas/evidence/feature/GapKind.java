 ...
 *
 * <p>A {@code COVERAGE_GAP} kind (done in Jira but no code) is deferred with the Jira-lifecycle field widening, in
 * step with the deferred {@code PARTIAL}/{@code COVERAGE_GAP} feature statuses.
 */
public enum GapKind {

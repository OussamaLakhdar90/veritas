...
@Command(
        ...
        subcommands = { EchoCommand.class, ValidateContractCommand.class, CreateDefectCommand.class,
                TestStrategyCommand.class, MultiSourceStrategyCommand.class, AnalyzeTestConditionsCommand.class,
                CreateTestCasesCommand.class, ReviewTestCasesCommand.class, ReleaseTestPlanCommand.class,
                ImplementTestsCommand.class, CopilotLoginCommand.class, DoctorCommand.class }
)

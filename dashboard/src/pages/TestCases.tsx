      ...
      {!query ? (
        ...
        <Card>
          <CardBody className="p-0">
            <Table stickyHead head={<><Th>{t('testCases.colTitle')}</Th><Th>{t('testCases.colTechnique')}</Th><Th>{t('testCases.colStatus')}</Th><Th>{t('testCases.colXray')}</Th><Th className="text-right">{t('testCases.colActions')}</Th></>}>
              {rows.map((tc, i) => (
